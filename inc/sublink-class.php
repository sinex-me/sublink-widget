<?php
/**
 * Adds Youtube_Subscribers widget.
 */
class sub_link_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'sublink_widget', // Base ID
			esc_html__( 'Youtube Sub', 'yts_domain' ), // Name
			array( 'description' => esc_html__( 'A Youtube Subscriber Widget', 'yts_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Youtube Sub', 'yts_domain' );
		$channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'Selama Production', 'yts_domain' );
        ...
        <p>
		    <label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>">
                <?php esc_attr_e( 'Subscribers Count:', 'yts_domain' ); ?>
            </label> 
		    <select 
                class="widefat" 
